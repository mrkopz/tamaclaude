// มาสคอตจิ๋วมุมขวาล่างของทุกหน้าที่ไม่ใช่หน้ามาสคอต — พอร์ตคู่กับ tools/gen/mini.py
// (เคยอยู่มุมขวาบน จนแถบบนกลายเป็นของทุกหน้าแล้วกินย่านนั้นไป — ก้นจอว่างพอดีทุกหน้า
// การย้ายจึงไม่ต้องขยับเนื้อหาของหน้าไหนเลยแม้แต่พิกเซลเดียว)
#include "ct_mini.h"

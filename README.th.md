...
จอมีมากกว่าหน้าเดียวแล้ว และหมุนเปลี่ยนหน้าเองทุก 20 วินาที นาฬิกาอยู่บนบอร์ด หน้าจึงหมุนต่อ
แม้ Mac จะหลับ
...
เปิดที่ **Settings ▸ Pages** แล้วพิมพ์ชื่อเมือง ตัวเลขมาจาก Open-Meteo — ไม่ต้องสมัคร ไม่ต้องมี
API key — โดย Mac เป็นคนดึงทุก 15 นาที บอร์ดยังไม่เคยต่ออินเทอร์เน็ตเอง

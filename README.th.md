...
ทุกหน้าบอกเสมอว่าตัวเลขอายุเท่าไร เพราะ Mac ที่หลับทำให้ทุกตัวเลขบนจอแช่แข็ง · หน้าอากาศมีมาสคอต
ย่อส่วนอยู่มุมจอด้วย จะได้ยังเห็นว่า session กำลังทำอะไร ส่วนหน้าคริปโต หุ้น และปฏิทินใช้มุมนั้น
เป็นแถวแรกของรายการแทน

| ข้อมูลสด | เก่าจนต้องเตือน | ยังไม่เคยมาถึง |
|:--|:--|:--|
| ![อากาศ](docs/images/weather_rain.gif) | ![เก่าเกินไป](docs/images/weather_stale.gif) | ![ยังไม่มีข้อมูล](docs/images/weather_empty.gif) |
| ตอนนี้เท่าไร สูงสุด/ต่ำสุดของวัน และข้อมูลอายุเท่าไร มาสคอตย่อไปอยู่มุมจอ จะได้ยังเห็นว่า session กำลังทำอะไร | เลยรอบดึงไปไกลแล้ว จึงบอกออกมาตรงๆ ไม่ใช่ซ่อนไว้ในตัวหนังสือเล็ก | หน้าบอกว่าขาดอะไรอยู่ ไม่ใช่โชว์โครงเปล่า |

เปิดหน้าไหน เรียงลำดับ และตั้งรอบหมุนได้ที่ **Settings ▸ Pages** · หน้าอากาศใส่ชื่อเมือง ตัวเลขมาจาก
...
เรื่องนี้ไม่ผ่านเครือข่ายเลย · watchlist ใส่ได้หน้าละห้าสัญลักษณ์
